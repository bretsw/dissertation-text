...
## RQ2. Tools in Early Career Teachers’ Induction Support Systems
...
## RQ3. People in Early Career Teachers’ Induction Support Systems
...
knitr::kable(table5,
  ...
  kableExtra::column_spec(1, bold=TRUE, border_right=FALSE) %>%
  pack_rows("Purpose: Planning, in-school", 
            1, 1, 
            label_row_css = "background-color: #23373B; color: #fff;") %>%
  pack_rows("Purpose: Planning, out-of-school", 
            2, 10, 
            label_row_css = "background-color: #23373B; color: #fff;") %>%
  pack_rows("Purpose: Enacting practice, out-of-school", 
            11, 12, 
            label_row_css = "background-color: #23373B; color: #fff;") %>%
  pack_rows("Purpose: Connecting socially, in-school", 
            13, 13, 
            label_row_css = "background-color: #23373B; color: #fff;") %>%
  pack_rows("Purpose: Connecting socially, out-of-school", 
            14, 16, 
            label_row_css = "background-color: #23373B; color: #fff;")
```
